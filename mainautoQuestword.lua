...
if getgenv().RuajadAutoQuestLoaded then
    return
end
...
local AUTOQUEST_RAW_URL = "https://gist.githubusercontent.com/armkkk123/93c7a384be75a8da1afd8a020f084bc0/raw/d000844451e387d1497be00fed72eb5f3aa94bd9/main_autoquest.lua"
...
local function createResumeOverlay()
    ...
    return {
        overlay = sg,
        status = status,
        continueBtn = makeBtn("Continue", "Continue", Color3.fromRGB(40, 140, 70), 10),
        openGuiBtn = makeBtn("OpenGUI", "Open GUI", Color3.fromRGB(50, 100, 185), 99),
        cancel = makeBtn("Cancel", "Cancel", Color3.fromRGB(170, 50, 50), 188),
    }
end
...
local function runResumeOverlay(alreadyConsumed)
    ...
    pcall(function()
        ...
        table.insert(conns, ui.continueBtn.MouseButton1Click:Connect(function()
            finish("continue")
        end))
    ...
    waitUntilPlayerAndDragonInWorld(function(ready, why)
        ...
        hideRayfieldGui()
        if ready then
            ui.status.Text = "Character + dragon loaded"
        else
    ...
    ui.status.Text = "Ready — continue or open GUI"
    ui.continueBtn.Visible = true
...
-- [[ 🎮 UI ]]
-- ============================================================
local pendingAutoResume = isChainPersistOn()
consumeAutoResume()
