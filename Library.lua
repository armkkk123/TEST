    ...
    function Library:MakeDraggable(handle, target, onDragEnd)
        ...
        local function onInputBegan(input, processed)
            ...
            if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                dragging   = true
                dragStart  = input.Position + guiInsetOffset
        ...
        local function onInputChanged(input)
            ...
            local delta = (input.Position + guiInsetOffset) - dragStart
        ...
        do
            ...
            function Tab:CreateSlider(options)
                ...
                local function PosToRel(pos)
                    ...
                    return math.clamp((pos.X - barBg.AbsolutePosition.X) / sizeX, 0, 1)
                end
                ...
                hitZone.InputBegan:Connect(function(i, processed)
                    ...
                    if i.UserInputType == Enum.UserInputType.MouseButton1 or i.UserInputType == Enum.UserInputType.Touch then
                        ...
                        local rel = PosToRel(i.Position + hitZoneInset)
                        if rel then
                            targetRel = rel
