...
function Library:CreateWindow(config)
    ...
    -- tween แค่ Position+Size+Rotation (ไม่แตะ mainScale กันบีบ 2 ต่อ)
    ...
    local function GenieHide()
        ...
        -- ขั้น 1: กระดาษเปล่า (fade cover ขึ้นคลุมเนื้อหา)
        ...
        task.delay(0.16, function()
            ...
            local downT = 0.42
            Library:Tween(MainFrame, {Position = destPos, Size = destSize, Rotation = -4}, downT, Enum.EasingStyle.Quart, Enum.EasingDirection.In):Play()
    ...
    local function GenieShow()
        ...
        -- เริ่มจากจุดปุ่มลอย (เล็ก + เอียง) แล้วกางออก
        local openIcon = openBtn:FindFirstChildOfClass("ImageLabel")
        ...
        local upT = 0.45
        Library:Tween(MainFrame, {Position = homePos, Size = homeSize, Rotation = 0}, upT, Enum.EasingStyle.Back, Enum.EasingDirection.Out):Play()
